          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link to="/auth?form=signup">
                <Button 
                  size="lg" 
                  className="relative bg-gradient-to-r from-[#0066CC] to-[#2B7CE5] hover:from-[#0052A3] hover:to-[#0066CC] text-white px-10 py-6 text-lg font-semibold rounded-lg shadow-2xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto group overflow-hidden"
                >
