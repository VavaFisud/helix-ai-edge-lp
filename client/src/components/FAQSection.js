...
const FAQSection = () => {
    ...
    return (_jsx("section", { className: "py-20 bg-gray-900", children: _jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx("h2", { className: "text-4xl font-bold text-white mb-6", children: "Frequently Asked Questions" }), _jsx("p", { className: "text-xl text-gray-300", children: "Everything you need to know about Helix Terminal" })] }), _jsx(Accordion, { type: "single", collapsible: true, className: "space-y-4", children: faqs.map((faq, index) => (_jsxs(AccordionItem, { value: `item-${index}`, className: "bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-lg px-6", children: [_jsx(AccordionTrigger, { className: "text-white hover:text-blue-400 text-left text-lg font-semibold py-6", children: faq.question }), _jsx(AccordionContent, { className: "text-gray-300 leading-relaxed pb-6", children: faq.answer })] }, index))) }), _jsx("div", { className: "mt-16 text-center", children: _jsxs("div", { className: "bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-lg p-8", children: [_jsx("h3", { className: "text-2xl font-bold text-white mb-4", children: "Still have questions?" }), _jsx("p", { className: "text-gray-300 mb-6", children: "Our team of trading experts is here to help you succeed" }), _jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [_jsxs("a", { href: "mailto:support@helixterminal.com", className: "inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors", children: [_jsxs("svg", { className: "w-5 h-5 mr-2", fill: "currentColor", viewBox: "0 0 20 20", children: [_jsx("path", { d: "M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" }), _jsx("path", { d: "M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" })] }), "Email Support"] }), _jsxs("a", { href: "tel:+1-555-123-4567", className: "inline-flex items-center px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg font-medium transition-colors", children: [_jsx("svg", { className: "w-5 h-5 mr-2", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { d: "M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" }) }), "Schedule Call"] })] })] }) })] }) }));
};
