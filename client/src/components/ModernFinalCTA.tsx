        ...
        <div className="text-center">
          ...
          <div className="mb-12">
            <Link to="/auth?form=signup">
              <Button 
                size="lg"
                className="relative bg-gradient-to-r from-[#0066CC] to-[#2B7CE5] hover:from-[#0052A3] hover:to-[#0066CC] text-white px-16 py-8 text-2xl font-bold rounded-2xl transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-[#0066CC]/25 group overflow-hidden"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-300"></span>
          ...
          <div className="bg-gradient-to-r from-[#0066CC]/20 to-[#2B7CE5]/20 border border-[#0066CC]/30 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <Link to="/auth?form=signup">
              <Button 
                size="lg"
                className="relative bg-gradient-to-r from-[#2B7CE5] to-[#10B981] hover:from-[#0066CC] hover:to-[#2B7CE5] text-white px-12 py-6 text-xl font-bold rounded-xl transform hover:scale-105 transition-all duration-300 group overflow-hidden"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-300"></span>
