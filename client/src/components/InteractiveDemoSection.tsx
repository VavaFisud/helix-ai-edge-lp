...
const InteractiveDemoSection = () => {
  ...
  const handleSendMessage = (message: string = userInput) => {
    ...
    // Simulate AI typing
    setTimeout(() => {
      const response = Object.prototype.hasOwnProperty.call(aiResponses, message) 
        ? aiResponses[message as keyof typeof aiResponses]
        : "I'd be happy to analyze that for you! Sign up for your free trial to access my full market intelligence capabilities and get personalized insights based on your trading style.";
