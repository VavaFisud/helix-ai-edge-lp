      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Join thousands of professional traders who have transformed their analysis 
            and profitability with Helix Terminal's collaborative AI intelligence.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 hover:border-blue-500/50 transition-all duration-300 group">
              <CardContent className="p-6">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-green-400 font-bold text-sm">{testimonial.metric}</div>
                    <a 
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-gray-400 text-sm">Verified Review</span>
                </div>
              </CardContent>
            </Card>
          ))}
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <span className="text-white">Anonymous Insights</span>
              </div>
            </div>
          </div>
        </div>
